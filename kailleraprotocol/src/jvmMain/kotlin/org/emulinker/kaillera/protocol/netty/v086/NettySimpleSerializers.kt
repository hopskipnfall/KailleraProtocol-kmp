...
import org.emulinker.kaillera.protocol.v086.AllReady
import org.emulinker.kaillera.protocol.v086.CachedGameData
import org.emulinker.kaillera.protocol.v086.ClientAck
import org.emulinker.kaillera.protocol.v086.CloseGame
import org.emulinker.kaillera.protocol.v086.GameKick
import org.emulinker.kaillera.protocol.v086.GameStatus
import org.emulinker.kaillera.protocol.v086.KeepAlive
import org.emulinker.kaillera.protocol.v086.PlayerDrop
import org.emulinker.kaillera.protocol.v086.PlayerDropNotification
import org.emulinker.kaillera.protocol.v086.PlayerDropRequest
import org.emulinker.kaillera.protocol.v086.Quit
import org.emulinker.kaillera.protocol.v086.QuitGame
import org.emulinker.kaillera.protocol.v086.QuitGameNotification
import org.emulinker.kaillera.protocol.v086.QuitGameRequest
import org.emulinker.kaillera.protocol.v086.QuitNotification
import org.emulinker.kaillera.protocol.v086.QuitRequest
import org.emulinker.kaillera.protocol.v086.ServerAck
...
object NettyGameStatusSerializer : NettyMessageSerializer<GameStatus> {
  ...
  override fun read(buffer: ByteBuf, messageNumber: Int, charset: String): GameStatus {
    ...
    return GameStatus(
      ...
      gameId,
      val1,
      org.emulinker.kaillera.model.GameStatus.fromByteValue(statusByte),
      numPlayers.toInt(),
      maxPlayers.toInt(),
    )
  }
