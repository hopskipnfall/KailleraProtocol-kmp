...
class SimpleMessageTests2 {
  ...
  fun gameStatus() {
    val msg =
      org.emulinker.kaillera.protocol.v086.GameStatus(
        messageNumber = 42,
        gameId = 13,
        val1 = 2345,
        gameStatus = org.emulinker.kaillera.model.GameStatus.SYNCHRONIZING,
        numPlayers = 4,
        maxPlayers = 4,
      )
    val hex = "00, 0D, 00, 29, 09, 01, 04, 04"
    testKmp(org.emulinker.kaillera.protocol.v086.GameStatus.GameStatusSerializer, msg, hex)
